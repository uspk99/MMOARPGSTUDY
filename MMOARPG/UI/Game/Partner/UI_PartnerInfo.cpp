...
void UUI_PartnerInfo::OnClickedCharacter(bool bClicked)
{
	...
	{
		InList->CallCharacterListByPredicate(
			[&](UUI_PartnerInfo* InInfo)->bool
			{
	...
	if (AMMOARPGPlayerController* InPlayerController = GetGameController<AMMOARPGPlayerController>())
	{
